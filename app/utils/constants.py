...
class NeuroAnalystConfig:
    ...
    # Template file names
    MAIN_SCRIPT_TEMPLATE = 'main_script.py.template'
    README_TEMPLATE = 'readme.md.template'
    REQUIREMENTS_TEMPLATE = 'requirements_script.sh.template'
    SINGULARITY_TEMPLATE = 'singularity.def.template'
    EXECUTE_TEMPLATE = 'execute_script.sh.template'
