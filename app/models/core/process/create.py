...
from ....utils.constants import COLLECTION_PROCESS_IMAGES, TEMPLATES_DIR
...
class ProcessImage(BaseModel):
    ...
    def from_user(cls, name: str, tag: str, description: str, base_docker_image: str, working_directory: dict, platform: Optional[str],
                ...
                #   expected_outputs: list[str], 
                  container_volumes: Optional[dict] = None, environment_variables: list[str] = ["BIDS_FILTERS"]) -> "ProcessImage":
        try:
